...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_pcs.sv \
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_pcs_ch.sv \
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_pma.sv \
  ...
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_rx_pma.sv \
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_tx_pma.sv \
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_tx_pma_ch.sv \
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_xcvr_h.sv \
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_xcvr_avmm_csr.sv \
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_xcvr_avmm_dcd.sv \
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_xcvr_avmm.sv \
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_xcvr_data_adapter.sv \
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_xcvr_native.sv \
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_xcvr_plls.sv \
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_hssi_10g_rx_pcs_rbc.sv \
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_hssi_10g_tx_pcs_rbc.sv \
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_hssi_8g_rx_pcs_rbc.sv \
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_hssi_8g_tx_pcs_rbc.sv \
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_hssi_8g_pcs_aggregate_rbc.sv \
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_hssi_common_pcs_pma_interface_rbc.sv \
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_hssi_common_pld_pcs_interface_rbc.sv \
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_hssi_pipe_gen1_2_rbc.sv \
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_hssi_pipe_gen3_rbc.sv \
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_hssi_rx_pcs_pma_interface_rbc.sv \
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_hssi_rx_pld_pcs_interface_rbc.sv \
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_hssi_tx_pcs_pma_interface_rbc.sv \
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_hssi_tx_pld_pcs_interface_rbc.sv \
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_xcvr_10gbaser_nr.sv \
  $QSYS_SIMDIR/altera_xcvr_10gbaser/sv_xcvr_10gbaser_native.sv \
