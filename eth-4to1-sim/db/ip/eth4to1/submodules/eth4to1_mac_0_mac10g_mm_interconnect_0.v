// eth4to1_mac_0_mac10g_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module eth4to1_mac_0_mac10g_mm_interconnect_0 (
	...
	wire         tx_bridge_s0_agent_rdata_fifo_out_valid;                                                               // tx_bridge_s0_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] tx_bridge_s0_agent_rdata_fifo_out_data;                                                                // tx_bridge_s0_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire         tx_bridge_s0_agent_rdata_fifo_out_ready;                                                               // avalon_st_adapter:in_0_ready -> tx_bridge_s0_agent_rdata_fifo:out_ready
	wire         avalon_st_adapter_out_0_valid;                                                                         // avalon_st_adapter:out_0_valid -> tx_bridge_s0_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                                                          // avalon_st_adapter:out_0_data -> tx_bridge_s0_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                                                         // tx_bridge_s0_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                                                         // avalon_st_adapter:out_0_error -> tx_bridge_s0_agent:rdata_fifo_sink_error
	wire         rx_bridge_s0_agent_rdata_fifo_out_valid;                                                               // rx_bridge_s0_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] rx_bridge_s0_agent_rdata_fifo_out_data;                                                                // rx_bridge_s0_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire         rx_bridge_s0_agent_rdata_fifo_out_ready;                                                               // avalon_st_adapter_001:in_0_ready -> rx_bridge_s0_agent_rdata_fifo:out_ready
	wire         avalon_st_adapter_001_out_0_valid;                                                                     // avalon_st_adapter_001:out_0_valid -> rx_bridge_s0_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                                                      // avalon_st_adapter_001:out_0_data -> rx_bridge_s0_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                                                     // rx_bridge_s0_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                                                     // avalon_st_adapter_001:out_0_error -> rx_bridge_s0_agent:rdata_fifo_sink_error
	...
	eth4to1_mac_0_mac10g_mm_interconnect_0_router router (
	...
	eth4to1_mac_0_mac10g_mm_interconnect_0_router_001 router_001 (
	...
	eth4to1_mac_0_mac10g_mm_interconnect_0_router_001 router_002 (
	...
	eth4to1_mac_0_mac10g_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (csr_clk_module_clk_clk),                                                           //        clk.clk
		.reset              (merlin_master_translator_reset_reset_bridge_in_reset_reset),                       //  clk_reset.reset
	...
	eth4to1_mac_0_mac10g_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (tx_clk_module_clk_clk),                       //       clk.clk
		.reset               (tx_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	eth4to1_mac_0_mac10g_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (rx_clk_module_clk_clk),                       //       clk.clk
		.reset               (rx_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	eth4to1_mac_0_mac10g_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (tx_clk_module_clk_clk),                       //       clk.clk
		.reset              (tx_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	eth4to1_mac_0_mac10g_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (rx_clk_module_clk_clk),                       //       clk.clk
		.reset              (rx_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	eth4to1_mac_0_mac10g_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (csr_clk_module_clk_clk),                                     //       clk.clk
		.reset               (merlin_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	eth4to1_mac_0_mac10g_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_0_data      (tx_bridge_s0_agent_rdata_fifo_out_data),      //     in_0.data
		.in_0_valid     (tx_bridge_s0_agent_rdata_fifo_out_valid),     //         .valid
		.in_0_ready     (tx_bridge_s0_agent_rdata_fifo_out_ready),     //         .ready
	...
	eth4to1_mac_0_mac10g_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_0_data      (rx_bridge_s0_agent_rdata_fifo_out_data),      //     in_0.data
		.in_0_valid     (rx_bridge_s0_agent_rdata_fifo_out_valid),     //         .valid
		.in_0_ready     (rx_bridge_s0_agent_rdata_fifo_out_ready),     //         .ready
